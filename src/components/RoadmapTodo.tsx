...
// React.memoを使用して再描画を最適化。
// 漢字変換中などのスムーズな入力を維持します。
const RoadmapTodo = memo(function RoadmapTodo({ roadmap = [], onChange, projectName = "不明なプロジェクト", scratchPad = "" }: RoadmapTodoProps) {
